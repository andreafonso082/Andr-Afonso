...
import { Zap, HardHat, Car, Lightbulb, CheckCircle, Quote, Star, FileText, Activity, Wrench, BatteryCharging, Cpu, Pen, Wifi, Layers } from 'lucide-react';
...
// Custom Lightning Bolt Component
  ...
  return (
    <div ref={containerRef} className="flex flex-col w-full relative">
      ...
      <section className="py-16 md:py-20 bg-white relative z-20">
        <div className="container mx-auto px-4 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 justify-center">
            ...
            />
            {/* 3. Telecommunications (Using Wifi icon as Router might be missing in some versions) */}
             <ServiceCard 
      ...
      >
        ...
        <AnimatePresence>
          {startHammer && !hasLitUp && (
            <div key="hammer-container" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 pointer-events-none w-full max-w-4xl h-64">
               <motion.div
                  key="hammer-bolt"
      ...
      <section className="py-12 md:py-16 bg-gray-50 border-t border-gray-200 overflow-hidden relative z-20">
        {/* Increased margin-bottom to 24 (6rem) for more spacing */}
        <div className="container mx-auto px-4 md:px-12 mb-24 md:mb-28">
